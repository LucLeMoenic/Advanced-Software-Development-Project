...
| R-13 | Tables have fewer than the required 10 records. | 4 | 5 | 20 | Automatic seeding was declined. Mitchell must create at least 10 valid records through the functional application and capture a count before submission. | Count below 10 blocks CI/demo readiness and FR-16 completion. | Mitchell | Application-created records and database/API count. |
