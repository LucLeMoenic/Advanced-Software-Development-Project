...
| ACC-05 | 5 | Implement deterministic backend workflow | FR-01 to FR-05, FR-09 to FR-14, FR-20, NFR-02 to NFR-03, NFR-08 to NFR-09, EV-01, EV-03 | Backend validates requests, retrieves candidates through the database API, ranks deterministically, persists results, and handles dependency failures. | Mitchell | Done |
