...
| ACC-05 | 5 | Implement deterministic backend workflow | FR-01 to FR-05, FR-09 to FR-14, FR-20, NFR-02 to NFR-03, NFR-08 to NFR-09, EV-01, EV-03 | Backend validates requests, retrieves/imports candidates through the database API, ranks deterministically, persists results, and handles dependency failures. | Mitchell | Done - 61 backend tests pass, including LiteAPI contract/import paths |
| ACC-06 | 6 | Integrate application Ollama ranking | FR-06 to FR-10, NFR-01 to NFR-03, NFR-06, NFR-08, EV-01, EV-03 | One configured application model ranks candidates; complete output validation and deterministic fallback are proven. | Mitchell | In progress - implementation and 46 backend tests complete; live-model evidence pending |
| ACC-07 | 7 | Build the traveller interface | FR-01, FR-03, FR-05, FR-10, FR-12 to FR-14, FR-18, FR-20, NFR-04 to NFR-05, NFR-07, EV-04, EV-09 | Browser supports search, results, fallback notice, reopen, rename, delete, keyboard use, focus handling, and required viewport widths. | Mitchell | In progress - componentised implementation and 7 frontend tests complete; manual viewport/integrated browser evidence pending |
...
| ACC-10 | 10 | Complete Student 1 CI | NFR-12, EV-08 | Student 1 workflow tests/builds the frontend, backend, database, and assigned containers without requiring live Ollama. | Mitchell | Implementation complete; GitHub Actions run evidence pending |
