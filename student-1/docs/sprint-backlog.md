...
| ACC-02 | 2 | Scaffold three healthy feature services | FR-19 to FR-20, NFR-09 to NFR-11 | Vue frontend, ASP.NET backend, and ASP.NET database API build, run in containers, and expose appropriate health behaviour. | Mitchell | Not started |
| ACC-03 | 3 | Implement accommodation catalogue | FR-04, FR-15 to FR-17, NFR-06, NFR-09 to NFR-10, EV-02 | Database API owns SQLite, supports catalogue CRUD/filtering, and idempotently seeds at least 10 valid accommodations. | Mitchell | Not started |
...
| Contract | Value |
|---|---|
| Final feature folder | `student-1/`, renamed before Phase 2 implementation |
